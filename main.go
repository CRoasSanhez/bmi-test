...
import (
	...
	"bodyMaxIndex/middleware"
	"bodyMaxIndex/web/controllers"
	"bodyMaxIndex/datasource"
...
func main() {
	...
	meassurement := mvc.New(app.Party("/calculate"))
	meassurement.Register(
		userService,
		sessManager.Start,
	)

	user.Handle(new(controllers.UserController))
	meassurement.Handle(new(controllers.MeassurementController))
